...
- [writing](https://blog.naver.com/hachu__) 📃
...
<details>
  <summary>경력기술요약 ~2022 (클릭하여 펼치기)</summary>

| 기간 | 내용 |
| :--- | :--- |
| **2021/01 ~ 2022/10** | **트레드링스 : 1년 10개월 근무**<br>- **업무**: Front-end 리드 (Angular14, React17), 웹 솔루션 유지보수<br>- **프로젝트**: Shipgo, Lingo 운영 / Zimgo 신규 개발 리드(10개월)<br>- **개인**: Next.js Admin, React17 모바일청첩장, Svelte 스터디 |
| **2019/09 ~ 2020/12** | **대한항공PJ : 1년 3개월 근무**<br>- 온라인 개편: Angular8 SPA, TypeScript 개발<br>- 메인 페이지 및 환불 프로세스 담당, W3C 웹접근성 적용 |
| **2019/02 ~ 2019/09** | **제주항공PJ : 7개월 근무**<br>- FareFamily & New Class (JS, FE 개발)<br>- 좌석 클래스 세분화에 따른 차등 화면 개발 |
| **2015/06 ~ 2019/02** | **아시아나 항공PJ : 3년 8개월 근무**<br>- 상용 우대 / 온라인 개편 / 환불 비용절감 / 모바일 개선 프로젝트<br>- 선호좌석 유료서비스 구축, 미국 WCAG 웹접근성(AAA) 적용<br>- **Stack**: Spring, Maven, Java, Oracle SQL, JS |
| **2015/03 ~ 2015/06** | **제주항공 중국 결제PJ : 3개월**<br>- JS, Java 개발 (UnionPay 등 중국 페이 시스템 연동) |
